...
const InputData = ({ InputDiv, setInputDiv, UpdatedData, setUpdatedData }) => {
  ...
  const submitData = async () => {
    if (Data.title === "" || Data.desc === "") {
      ...
      await axios.post("https://taskmanagement-backend-qmba.onrender.com/api/v2/create-task", Data, {
        headers,
      });
      setData({ title: "", desc: "" });
      setInputDiv("hidden");
  ...
  const UpdateTask = async () => {
    if (Data.title === "" || Data.desc === "") {
      ...
      await axios.put(
        `https://taskmanagement-backend-qmba.onrender.com/api/v2/update-task/${UpdatedData.id}`,
        Data,
        {
          headers,
        }
